        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                    <form action="{{ route('admin.siswa.daftar.store') }}" method="post">
                        @csrf
                        <div class="card card-secondary shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="phone">Telepon Siswa</label>
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        placeholder="Telepon Siswa" value="{{ old('phone') }}" required />
                                    @error('phone')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="Email Siswa" value="{{ old('email') }}" required />
                                    @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password"
                                        placeholder="Password Siswa" autocomplete="new-password" required />
                                    @error('password')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @csrf
                    <div class="form-group">
                        <label for="name_edit">Nama Siswa</label>
                        <input type="text" class="form-control" id="name_edit" name="name" placeholder="Nama Siswa"
                            required />
                    </div>
                    <div class="form-group">
                        <label for="phone_edit">Telepon Siswa</label>
                        <input type="text" class="form-control" id="phone_edit" name="phone" placeholder="Telepon Siswa"
                            required />
                    </div>
                    <div class="form-group">
                        <label for="address_edit">Alamat Siswa</label>
...
@include('admin.siswa.daftar.main_vitamin')
@endsection