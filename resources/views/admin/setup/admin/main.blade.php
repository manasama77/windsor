        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                    <form action="{{ route('admin.setup.admin.store') }}" method="post">
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password"
                                        placeholder="Password Admin" autocomplete="new-password" required />
                                    @error('password')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name_edit" name="name" placeholder="Nama Admin"
                            required />
                    </div>
                </div>
                <div class="modal-footer">
...
@include('admin.setup.admin.main_vitamin')
@endsection